...
class Received(models.Model):
    ...
    entity = models.CharField(choices=Government, max_length=100)  # Adjust max_length if needed
    institution = models.CharField(max_length=100)
    priority = models.CharField(choices=Priority, max_length=100)  # Adjust max_length if needed
    date_received = models.DateField(max_length=10)
...
class Sent(models.Model):
    ...
    institution = models.CharField(max_length=100)
    date_sent = models.DateField(max_length=10)
